    ...
    <>
      ...
      >
        ...
        <div className="flex-grow overflow-y-auto">
          {amount > 0 ? (
            <div className="w-full flex flex-col px-3 mb-[200px]">
              {cartItems.map((item) => {
            ...
            <div className="flex justify-center items-center h-[300px] flex-col gap-6 pt-32">
              ...
              />
              <h2 className="font-poppins font-semibold text-xl tracking-wide pl-2">
                Grab a coffee
              </h2>
            </div>
          )}
      ...
      {amount > 0 && (
        <div
          data-aos="slide-left"
          data-aos-duration="600"
          className="fixed bottom-0 right-0 bg-coffee pt-10 pb-10 flex items-center flex-col w-full md:w-[375px] z-[110]"
        >
